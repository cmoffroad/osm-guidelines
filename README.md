...
- Make sure to add [surface=unpaved](https://wiki.openstreetmap.org/wiki/Tag:surface=unpaved) if the road seems not paved. This is to ensure routers don't redirect normal traffic through off-road conditions. 
