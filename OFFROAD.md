...
Use this [Decision Tree](https://github.com/cmoffroad/osm-guidelines/blob/main/README.md#path-classification) to find out what should be the appropriate tag.
...
Use this [Decision Tree](https://github.com/cmoffroad/osm-guidelines/blob/main/README.md#minor-road-classification) to find out what should be the appropriate tag.
